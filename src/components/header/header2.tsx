...
const Main = (
// bg chimba bg-gray-900
<main className="relative h-screen overflow-hidden font-mono bg-white dark:bg-black">
...
<header className="z-30 flex items-center w-full h-20 sm:h-32">
...
<div className="relative z-20 flex items-center">
    <div className="container relative flex flex-col items-center justify-between px-6 py-4 mx-auto">
        <div className="flex flex-col">
            {/* <Image alt="" src="https://www.okchicas.com/wp-content/uploads/2016/08/personas-inteligentes.jpg" className="mx-auto rounded-full w-28" width={30} height={30}/> */}
            ...
            <h2 className="max-w-3xl py-2 mx-auto text-5xl font-bold text-center text-gray-800 md:text-6xl dark:text-white">
                Building your future, solving situations quickly, and living a better life experience.
            </h2>
            ...
            {/* <div className="flex items-center justify-center mt-4">
              <div className="font-mono px-4 py-2 mx-2 text-whit ">
                Credit Personal
              </div>
            <div className="font-mono px-4 py-2 mx-2 text-whit ">
                Product Credit
            ...
            <div className="flex items-center justify-center mt-4">
            <div className="font-mono px-4 py-2 mx-2 text-white relative group">
                Credit Personal
                <div className="absolute bg-blue-500 h-1 w-full bottom-0 left-0 transform origin-bottom scale-x-0 transition-transform duration-300 ease-in-out group-hover:scale-x-100"></div>
                <div className="absolute bg-blue-500 h-0.5 w-full bottom-0 left-0 transform origin-bottom scale-x-0 transition-transform duration-300 ease-in-out group-hover:scale-x-100"></div>
            </div>
            <div className="font-mono px-4 py-2 mx-2 text-white relative group">
                Product Credit
                <div className="absolute bg-blue-500 h-1 w-full bottom-0 left-0 transform origin-bottom scale-x-0 transition-transform duration-300 ease-in-out group-hover:scale-x-100"></div>
